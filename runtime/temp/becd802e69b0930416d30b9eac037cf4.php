<?php /*a:3:{s:72:"/Applications/MAMP/htdocs/vancms/application/admin/view/index/index.html";i:1585844363;s:72:"/Applications/MAMP/htdocs/vancms/application/admin/view/common/head.html";i:1585843137;s:72:"/Applications/MAMP/htdocs/vancms/application/admin/view/common/foot.html";i:1585917775;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main">
            <div class="admin-login-box">
                <a class="logo" style="left: 0;" href="<?php echo url('admin/index/index'); ?>">
                    <span style="font-size: 22px;"><?php echo config('cms.sys_name'); ?></span>
                </a>
            ...
            <ul class="layui-nav admin-header-item" lay-filter="side-top-right">
                ...
                <li class="layui-nav-item">
                    <a href="<?php echo url(config('app.default_module').'/index/index'); ?>" target="_blank">查看主页</a>
                </li>
                <li class="layui-nav-item">
    ...
    <div class="layui-body" style="bottom: 0;border-left: solid 2px #009688;" id="admin-body">
    ...
    <div class="layui-footer footer footer-demo" id="admin-footer">
        <div class="layui-main">
            <p>2019 &copy;
                <a href="http://www.fgc1024.cn/">www.fgc1024.cn</a> Apache Licence 2.0
            </p>
        </div>
    </div>
